...
const ApiInsightsTooltip = ({ visible, onMouseEnter, onMouseLeave }) => {
    ...
    return (
        <div className='hover-card_bottom absolute top-full left-1/2 transform-translate-x-1/2 mt-1 bg-white dark:bg-gray-500 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50 w-60 sm:2-72 transition-all duration-500 overflow-hidden'
            ...
            <div className='p-3'>
                ...
                <div className='space-y-1.5 text-xs'>
                    <div className='flex items-center gap-2'>
                        <CheckCircle className='h3 w-3 text-green-400 dark:text-green-400' />
